...
from main.views.views import ContentList, ContentDetail, DifficultyList, DifficultyDetail, CountryList, CountryDetail, CategoryTypeList, CategoryTypeDetail, CategoryList, CategoryDetail
